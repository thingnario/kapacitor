...
import (
	...
	iclient "github.com/thingnario/kapacitor/influxdb"
	...
	"github.com/thingnario/kapacitor/services/azure"
	"github.com/thingnario/kapacitor/services/config"
	"github.com/thingnario/kapacitor/services/consul"
	"github.com/thingnario/kapacitor/services/deadman"
	"github.com/thingnario/kapacitor/services/diagnostic"
	"github.com/thingnario/kapacitor/services/dns"
	"github.com/thingnario/kapacitor/services/ec2"
	"github.com/thingnario/kapacitor/services/file_discovery"
	"github.com/thingnario/kapacitor/services/gce"
	...
	"github.com/thingnario/kapacitor/services/influxdb"
	"github.com/thingnario/kapacitor/services/k8s"
	"github.com/thingnario/kapacitor/services/kafka"
	"github.com/thingnario/kapacitor/services/load"
	"github.com/thingnario/kapacitor/services/marathon"
	"github.com/thingnario/kapacitor/services/mqtt"
	"github.com/thingnario/kapacitor/services/nerve"
	"github.com/thingnario/kapacitor/services/noauth"
	...
	"github.com/thingnario/kapacitor/services/replay"
	"github.com/thingnario/kapacitor/services/reporting"
	"github.com/thingnario/kapacitor/services/scraper"
	"github.com/thingnario/kapacitor/services/sensu"
	"github.com/thingnario/kapacitor/services/serverset"
	"github.com/thingnario/kapacitor/services/servicetest"
	...
	"github.com/thingnario/kapacitor/services/static_discovery"
	"github.com/thingnario/kapacitor/services/stats"
	"github.com/thingnario/kapacitor/services/storage"
	"github.com/thingnario/kapacitor/services/swarm"
	"github.com/thingnario/kapacitor/services/talk"
	"github.com/thingnario/kapacitor/services/task_store"
	"github.com/thingnario/kapacitor/services/telegram"
	"github.com/thingnario/kapacitor/services/triton"
	"github.com/thingnario/kapacitor/services/udf"
	"github.com/thingnario/kapacitor/services/udp"
