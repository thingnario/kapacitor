...
import (
	...
	"github.com/thingnario/kapacitor/command/commandtest"
	...
	"github.com/thingnario/kapacitor/services/alert/alerttest"
	"github.com/thingnario/kapacitor/services/alerta"
	"github.com/thingnario/kapacitor/services/alerta/alertatest"
	"github.com/thingnario/kapacitor/services/diagnostic"
	"github.com/thingnario/kapacitor/services/hipchat"
	"github.com/thingnario/kapacitor/services/hipchat/hipchattest"
	"github.com/thingnario/kapacitor/services/httppost"
	"github.com/thingnario/kapacitor/services/httppost/httpposttest"
	k8s "github.com/thingnario/kapacitor/services/k8s/client"
	"github.com/thingnario/kapacitor/services/k8s/k8stest"
	"github.com/thingnario/kapacitor/services/kafka"
	"github.com/thingnario/kapacitor/services/kafka/kafkatest"
	"github.com/thingnario/kapacitor/services/opsgenie"
	"github.com/thingnario/kapacitor/services/opsgenie/opsgenietest"
	"github.com/thingnario/kapacitor/services/opsgenie2"
	"github.com/thingnario/kapacitor/services/opsgenie2/opsgenie2test"
	"github.com/thingnario/kapacitor/services/pagerduty"
	"github.com/thingnario/kapacitor/services/pagerduty/pagerdutytest"
	"github.com/thingnario/kapacitor/services/pagerduty2"
	"github.com/thingnario/kapacitor/services/pagerduty2/pagerduty2test"
	"github.com/thingnario/kapacitor/services/pushover"
	"github.com/thingnario/kapacitor/services/pushover/pushovertest"
	"github.com/thingnario/kapacitor/services/sensu"
	"github.com/thingnario/kapacitor/services/sensu/sensutest"
	"github.com/thingnario/kapacitor/services/sideload"
	"github.com/thingnario/kapacitor/services/slack"
	"github.com/thingnario/kapacitor/services/slack/slacktest"
	"github.com/thingnario/kapacitor/services/smtp"
	"github.com/thingnario/kapacitor/services/smtp/smtptest"
	"github.com/thingnario/kapacitor/services/snmptrap"
	"github.com/thingnario/kapacitor/services/snmptrap/snmptraptest"
	"github.com/thingnario/kapacitor/services/storage/storagetest"
	"github.com/thingnario/kapacitor/services/swarm/swarmtest"
	"github.com/thingnario/kapacitor/services/talk"
	"github.com/thingnario/kapacitor/services/talk/talktest"
	"github.com/thingnario/kapacitor/services/telegram"
	"github.com/thingnario/kapacitor/services/telegram/telegramtest"
	"github.com/thingnario/kapacitor/services/victorops"
	"github.com/thingnario/kapacitor/services/victorops/victoropstest"
	"github.com/thingnario/kapacitor/udf"
	"github.com/thingnario/kapacitor/udf/agent"
	"github.com/thingnario/kapacitor/udf/test"
...
func testStreamerWithSteppedOutput(
	...
	for s, step := range steps {
		...
		//Read at github.com/thingnario/kapacitor.(*HTTPOutNode).Endpoint()
		//Previous write at github.com/thingnario/kapacitor.(*HTTPOutNode).runOut()
		resp, err := http.Get(output.Endpoint())
		if err != nil {
			t.Fatal(err)
		}
